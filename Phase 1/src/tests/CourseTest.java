...
public class CourseTest {
	...
	public void studentsTest() 
	{
		...
		flying.set_student_names(students);
		
		Vector<String> actual = flying.get_student_names();
	...
	public void getProfessorTest() {
		...
		String actual = flying.get_professor_name();
	...
	public void getMinGradeTest() {
		flying = new Course("flying", "Madame Hooch", 'O', 1996);
		char expected = 'O';
		char actual = flying.get_min_grade();
	...
	public void setProfessorTest() {
		flying = new Course("Flying");
		flying.set_professor_name("Madame Hooch");
		String expected = "Madame Hooch";
		String actual = flying.get_professor_name();
